...
// Load this file's selection again by visiting: http://mootools.net/more/0a8c84858d51e3d99375979accf0984a 
// Or build this file again with packager using: packager build More/Array.Extras More/Date.Extras More/Number.Format More/Hash More/Form.Request More/Form.Validator.Inline More/Form.Validator.Extras More/OverText More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Slider More/Sortables More/Request.JSONP More/Assets More/HtmlTable.Zebra More/HtmlTable.Sort More/Keyboard.Extras More/Spinner More/Locale.en-US.Number
/*
---
copyrights:
...
}if(a.decimals==null){a.decimals=2;}return this.format(a);}});(function(){if(this.Hash){return;}var a=this.Hash=new Type("Hash",function(b){if(typeOf(b)=="hash"){b=Object.clone(b.getClean());
...
if(a==c.length){b.onComplete();}},onerror:function(){a++;b.onError.call(this,a,d,e);if(a==c.length){b.onComplete();}}}));}));}};var HtmlTable=new Class({Implements:[Options,Events,Class.Occlude],options:{properties:{cellpadding:0,cellspacing:0,border:0},rows:[],headers:[],footers:[]},property:"HtmlTable",initialize:function(){var a=Array.link(arguments,{options:Type.isObject,table:Type.isElement});
